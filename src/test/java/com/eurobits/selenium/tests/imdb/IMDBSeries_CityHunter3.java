...
@Test
public class IMDBSeries_CityHunter3 extends BaseTestCase {

	private static final Logger LOG = LoggerFactory.getLogger(IMDBSeries_CityHunter3.class);

	private final String MAIN_TITLE = "CityHunter3";
