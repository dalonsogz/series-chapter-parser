...
@Test
public class IMDBSeries_Galavant_S02 extends BaseTestCase {

	private static final Logger LOG = LoggerFactory.getLogger(IMDBSeries_Galavant_S02.class);

	private final String MAIN_TITLE = "Galavant_S02";
	...
	public void writeEpisodesTitles()  {
		 ...
		 */
		LOG.debug("INICIO");
		LOG.debug("00 -Caso de Prueba: IMDB Capitulos Series - Galavant (2015–2016)");
