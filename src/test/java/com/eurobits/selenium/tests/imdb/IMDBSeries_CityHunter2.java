...
@Test
public class IMDBSeries_CityHunter2 extends BaseTestCase {

	private static final Logger LOG = LoggerFactory.getLogger(IMDBSeries_CityHunter2.class);

	private final String MAIN_TITLE = "CityHunter2";
