...
@Test
public class IMDBSeries_CityHunter1 extends BaseTestCase {

	private static final Logger LOG = LoggerFactory.getLogger(IMDBSeries_CityHunter1.class);

	private final String MAIN_TITLE = "CityHunter1";
