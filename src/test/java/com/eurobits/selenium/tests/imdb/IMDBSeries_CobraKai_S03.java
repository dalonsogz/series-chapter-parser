...
@Test
public class IMDBSeries_CobraKai_S03 extends BaseTestCase {

	private static final Logger LOG = LoggerFactory.getLogger(IMDBSeries_CobraKai_S03.class);

	private final String MAIN_TITLE = "CobraKai_S03";
	...
	public void writeEpisodesTitles()  {
		 ...
		 */
		LOG.debug("INICIO");
		LOG.debug("00 -Caso de Prueba: IMDB Capitulos Series - Cobra Kai (2018-)");
