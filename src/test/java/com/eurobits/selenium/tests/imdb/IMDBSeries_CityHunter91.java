...
@Test
public class IMDBSeries_CityHunter91 extends BaseTestCase {

	private static final Logger LOG = LoggerFactory.getLogger(IMDBSeries_CityHunter91.class);

	private final String MAIN_TITLE = "CityHunter91";
	...
	public void writeEpisodesTitles()  {
		 ...
		 */
		LOG.debug("INICIO");
		LOG.debug("00 -Caso de Prueba: IMDB Capitulos Series - City Hunter (1987–1991)");
